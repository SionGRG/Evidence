	...
	const std::string& b5, const std::string& b5Name)
{
	...
	pT1->mW = pB1->mW * .8f;
	pT1->mH = pB1->mH * .9f;
	pT1->mX = pB1->mW / 2 - pT1->mW / 3;
	pT1->mY = pB1->mH / 2 - pT1->mH / 2.5;
	...
	pT2->mW = pB2->mW * .8f;
	pT2->mH = pB2->mH * .9f;
	pT2->mX = pB2->mW / 2 - pT2->mW / 3;
	pT2->mY = pB2->mH / 2 - pT2->mH / 2.5;
	...
	pT3->mW = pB3->mW * .8f;
	pT3->mH = pB3->mH * .9f;
	pT3->mX = pB3->mW / 2 - pT3->mW / 2;
	pT3->mY = pB3->mH / 2 - pT3->mH / 3;
	...
	pT4->mW = pB4->mW * .8f;
	pT4->mH = pB4->mH * .9f;
	pT4->mX = pB4->mW / 2 - pT4->mW / 3;
	pT4->mY = pB4->mH / 2 - pT4->mH / 2.5;
	...
	pT5->mW = pB5->mW * .8f;
	pT5->mH = pB5->mH * .9f;
	pT5->mX = pB5->mW / 2 - pT5->mW / 3;
	pT5->mY = pB5->mH / 2 - pT5->mH / 2.5;
